...
//concat() : 여러개의 배열을 이어 붙여서 합친 결과를 반환한다.(수행시간 : 0(N))
let arr9 = [1, 2, 3];
let arr10 = [4, 5, 6];
...
//slice(left,right) : 특정 구간의 원소를 꺼낸 배열을 반환한다.(수행시간 : 0(N))
let arr12 = [1, 2, 3, 4, 5];
let result = arr12.slice(2, 4);

console.log(result);

//indexOf() : 특정 값을 가진 원소의 첫번째 인덱스를 반환한다,(수행시간 : 0(N))
